...
The hydration and sodium pattern above is also reusable for the late-camp cut. See [how to rehydrate after weigh-in](/blog/how-to-rehydrate-after-weigh-in) for the same principles applied to the post-weigh-in window.
...
See [wearable data and nutrition: connecting the dots](/blog/wearable-data-and-nutrition-connecting-the-dots) for the broader framework on reading wearable signals against nutrition decisions.
