---
title: "Catch-Weight and Late Contract Changes: Re-Planning the Cut When the Number Moves"
description: "The opponent missed weight. The promoter offered a catch-weight. The fight is in nine days. Here is how a camp re-runs the cut math without panicking — and the four mistakes that show up when the number moves late."
date: 2026-05-19
...
For Pattern A (smaller cut), the cornerman bag is the same as a standard fight night — see [the cornerman's nutrition bag post](/blog/cornerman-nutrition-bag-fight-night) — minus one carb-gel and one bottle of electrolyte mix. The rehydration math is smaller.
